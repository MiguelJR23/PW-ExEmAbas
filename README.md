...
A ideia é fazer os seguintes exercícios em abas(há um exemplo de como faze-lo em abas) e então o "processar.php" mostra o resultado dependendo do que foi pedido, mas apenas de um, não de dois ou mais ao mesmo tempo:
